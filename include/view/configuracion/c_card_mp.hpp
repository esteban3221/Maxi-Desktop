...
public:
    ...
    // property's
    Glib::ustring &property_id();
    Glib::ustring &property_tipo();
    Glib::ustring &property_alias();
    Glib::ustring &property_descripcion();
    Glib::DateTime &property_fecha_creado();
    Glib::ustring &property_modo();
    bool &property_predeterminado();
